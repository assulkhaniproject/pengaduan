<div>
    <!-- Start Hero -->
    <section class="py-36 md:py-64 w-full table relative bg-[url('../../assets/images/bg-video.html')] bg-center bg-no-repeat">
        <div class="absolute top-0 left-0 w-full h-full z-0 pointer-events-none overflow-hidden">
            <iframe src="https://player.vimeo.com/video/33955001?background=1&amp;autoplay=1&amp;loop=1&amp;byline=0&amp;title=0" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-screen h-[56.25vw] min-h-screen min-w-[177.77vw]"></iframe>
        ...
        <div class="container relative">
            <div class="grid grid-cols-1 text-center">
                ...
                <h4 class="text-white lg:text-5xl text-4xl lg:leading-normal leading-normal font-medium my-6 position-relative">Community Complaints</h4>
            
                <p class="text-white opacity-50 mb-0 max-w-2xl text-lg mx-auto">Responding in a timely manner to claims or complaints will allow Orbia to properly manage its relations with its social environment, and thus produce a positive impact on its reputation.</p>
    ...
    <section class="relative md:py-24 py-16">
        <div class="container">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="md:col-span-7">
                    <div class="lg:ml-4">
                        <h4 class="mb-6 md:text-3xl text-2xl lg:leading-normal leading-normal font-medium">We Are Ready to <br> Serve You</h4>
                        <p class="text-slate-400 max-w-xl">In a democratic country, public complaints are a form of citizen independence to participate in public policy as well as a form of acknowledgment of the people's sovereignty from the state.</p>
        ...
        {{-- <div class="container md:mt-24 mt-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                <div class="p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
        ...
        {{-- <div class="container-fluid relative md:mt-24 mt-16">
            <div class="grid grid-cols-1 py-36 bg-[url('../../assets/images/team.html')] bg-center bg-no-repeat">
        ...
        <div class="container md:mt-24 mt-16">
            <div class="grid grid-cols-1 pb-8 text-center">
                <h6 class="text-indigo-600 text-sm font-bold uppercase mb-2">Complaint</h6>
                <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">News Complaint</h3>
